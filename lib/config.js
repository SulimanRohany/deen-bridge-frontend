...
export const config = {
  ...
  ICE_SERVERS: [
    {
      urls: [
        process.env.NEXT_PUBLIC_STUN_URL || "stun:yourdomain.com:3478",
        process.env.NEXT_PUBLIC_TURN_UDP_URL || "turn:yourdomain.com:3478?transport=udp",
        process.env.NEXT_PUBLIC_TURN_TCP_URL || "turn:yourdomain.com:3478?transport=tcp"
      ],
      username: process.env.NEXT_PUBLIC_TURN_USERNAME || "turnuser",
      credential: process.env.NEXT_PUBLIC_TURN_CREDENTIAL || "yourpassword"
    }
  ],
  ...
  ENDPOINTS: {
    ...
    BLOG: {
      ...
      POST_LIKE: 'blog/post/{id}/like/',
      POST_RELATED: 'blog/post/slug/{slug}/related/',
      COMMENTS: 'blog/comment/',
      COMMENT_BY_ID: 'blog/comment/{id}/',
      COMMENT_LIKE: 'blog/comment/{id}/like/',
    },
    ...
    DASHBOARD: {
      ...
      PARENT_CHILD_DETAIL: 'dashboard/parent/child/{child_id}/',
    },
    ...
    USER: {
      ...
      CREATE_PARENT_ACCOUNT: 'auth/create-parent-account/',
    },
