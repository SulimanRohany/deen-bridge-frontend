                ...
                <div className="relative z-10 space-y-6 animate-fade-in-up" style={{animationDelay: '0.2s'}}>
                    ...
                    <div className="space-y-4 pt-6">
                        <div className="flex items-start space-x-3 text-white/90">
                            <IconMail className="w-6 h-6 flex-shrink-0 mt-1" />
                            <p className="text-lg">Check your inbox for a verification email</p>
                        </div>
                        <div className="flex items-start space-x-3 text-white/90">
                            <IconCheck className="w-6 h-6 flex-shrink-0 mt-1" />
                            <p className="text-lg">Click the link to verify your account</p>
                        </div>
                        <div className="flex items-start space-x-3 text-white/90">
                            <IconCheck className="w-6 h-6 flex-shrink-0 mt-1" />
                            <p className="text-lg">Then you can log in and get started</p>
                        </div>
                    </div>
                </div>
                        ...
                        <div className="text-center space-y-4">
                            ...
                            <div className="space-y-2">
                                ...
                                <p className="text-muted-foreground">
                                    We've sent a verification link to {email ? <span className="font-semibold">{email}</span> : 'your email address'}.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="space-y-4">
                                ...
                                {resendSuccess ? (
                                    ...
                                    <button
                                        ...
                                        disabled={loading}
                                        className="w-full h-12 border-2 border-primary text-primary rounded-lg font-semibold hover:bg-primary/10 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
                                    >
                                        {loading ? (
                                            <>
